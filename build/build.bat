...
@REM NOTE: Dev build
set PREPROCESSOR_DEFINES=/D USE_ASSERTIONS=1 /D USE_FAST_COLOR_FUNCTIONS=1 /D USE_LOGGING=1
set COMPILER_FLAGS=/Zi /O2 /Ob3 %PREPROCESSOR_DEFINES%
set LINKER_FLAGS=%COMMON_LINKER_FLAGS%

@REM NOTE: Release build
set PREPROCESSOR_DEFINES=/D USE_ASSERTIONS=0 /D USE_FAST_COLOR_FUNCTIONS=1 /D USE_LOGGING=0
set COMPILER_FLAGS=/O2 /Ob3 /GL %PREPROCESSOR_DEFINES%
set LINKER_FLAGS=%COMMON_LINKER_FLAGS%


@REM HACK dumb way of setting actual build (copy here)
@REM NOTE: Debug build
set PREPROCESSOR_DEFINES=/D USE_ASSERTIONS=1 /D USE_FAST_COLOR_FUNCTIONS=1 /D USE_LOGGING=1
set COMPILER_FLAGS=/Zi /Ob1 %PREPROCESSOR_DEFINES%
set LINKER_FLAGS=%COMMON_LINKER_FLAGS%
